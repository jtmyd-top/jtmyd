...
font_path = r'D:\OneDrive - cvxbdf88\XXR\pythone\jtmyd\myapp\static\utils\kumo.ttf'
def check_code(width=120, height=30, char_length=5, font_file=font_path, font_size=28):
    ...
    code = []   # 用于存放每个验证码
    img = Image.new(mode='RGB', size=(width, height), color='#f0f3f8')#创建画布
    ...
    def rndChar():
        ...
        :return:
        """
        return chr(random.randint(70, 90))
