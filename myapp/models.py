...
class T_User(models.Model):
	username = models.CharField(verbose_name="用户名", max_length=18, primary_key=True)
	...
	capacity  = models.DecimalField(verbose_name="存储总容量(G)",default=10.000,max_digits=6,decimal_places=3)
	Usedspace = models.DecimalField(verbose_name="已用容量(G)", default=0, max_digits=6, decimal_places=3)
	Residual_capacity = models.DecimalField(verbose_name="剩余容量(G)", default=10, max_digits=6, decimal_places=3)
...
class T_File(models.Model):
	...
	createTime = models.DateTimeField(verbose_name="文件(夹)删除日期",null=True,blank=True)
